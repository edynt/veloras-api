...
// Convert from SQLC ListStoresRow to domain entity
func FromSQLCStoreWithDetailsFromList(s gen.ListStoresRow) StoreWithDetails {
	return StoreWithDetails{
		Store: Store{
			ID:          s.ID.String(),
			UserID:      s.UserID,
		...
		UserName:  convertInterfacePtr(s.OwnerName),
		UserEmail: convertTextPtr(s.OwnerEmail),
	}
}

// Convert from SQLC SearchStoresRow to domain entity
func FromSQLCStoreWithDetailsFromSearch(s gen.SearchStoresRow) StoreWithDetails {
	return StoreWithDetails{
		Store: Store{
			ID:          s.ID.String(),
			UserID:      s.UserID,
...
// Convert from SQLC GetStoreByUserIDRow to domain entity
func FromSQLCStoreWithDetailsFromGetByUserID(s gen.GetStoreByUserIDRow) StoreWithDetails {
	return StoreWithDetails{
		Store: Store{
			ID:          s.ID.String(),
			UserID:      s.UserID,
